...
=======
    ...
    public List<UploadResultDTO> upload1(MultipartFile[] files) {
        ...
        for (MultipartFile file : files) {
            ...
            String nt_uuid = UUID.randomUUID().toString();

            String saveName = nt_uuid + "_" + originalFileName;
            log.info(file.getResource());
            String saveFolder = makeFolders();

            File saveFile = new File("C:\\notice\\"+ saveFolder + "\\" + saveName);
