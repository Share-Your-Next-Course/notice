        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${dtoList}" var="question">
                                    <tr>
                                        ...
                                        <td><a href='/question/read/${question.q_id}' class="dtoLink">
                    ...
                    <form class="actionForm" action="/question//list" method="get">
                    ...
                    <script>
                        ...
                        linkDiv.addEventListener("click", (e) => {
                            ...
                            actionForm.setAttribute("action", "/question/list")
                            actionForm.submit()
                        }, false)
