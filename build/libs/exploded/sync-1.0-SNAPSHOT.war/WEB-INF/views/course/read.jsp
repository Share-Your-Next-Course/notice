    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="ri-treasure-map-fill"></i></i><span>코스 관리</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">ㅁㄴㅇㄴ</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">ㄴㅁㅇㄻㅇㄹ</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">성별</div>
                                    <div class="col-lg-9 col-md-8">ㄴㅁㅇㄹ</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">활동지역</div>
                                    <div class="col-lg-9 col-md-8">ㅁㅇㄹ</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">ㅁㄴㅇㄹ</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">가입일자</div>
                                    <div class="col-lg-9 col-md-8">ㅁㅇㄴㄻ</div>
                                </div>
